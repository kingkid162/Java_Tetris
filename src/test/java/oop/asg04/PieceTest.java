...
public class PieceTest{
    ...
    @Test
    public void testWidthStudent() {
        assertEquals(2, pyramid.computeNextRotation().getWidth());
        assertEquals(3, (new Piece("0 0 0 1 1 0 2 0")).getWidth());
        assertEquals(2, (new Piece("0 0 0 1 1 1 1 2")).getWidth());
        assertEquals(4, stick.computeNextRotation().getWidth());
        assertEquals(2, l2.getWidth());
    }
    
    @Test
    public void testHeightStudent() {
        assertEquals(4, stick.computeNextRotation().computeNextRotation().getHeight());
        assertEquals(3, (new Piece("0 1 1 0 1 1 1 2")).getHeight());
    ...
    @Test
    public void testSkirtStudent() {
        assertTrue(Arrays.equals(new int[]{1, 0, 0}, (new Piece("0 1 1 1 1 0 2 0")).getSkirt()));
        assertTrue(Arrays.equals(new int[] {0 , 1}, (new Piece("0 0 1 2 1 1 0 1")).getSkirt()));
        assertTrue(Arrays.equals(new int[] {0, 0, 0, 0}, stick.computeNextRotation().getSkirt()));
        assertTrue(Arrays.equals(new int[] {1, 1, 0}, (new Piece("0 1 1 1 2 1 2 0")).getSkirt()));
        assertTrue(Arrays.equals(new int[] {1, 0, 1}, (new Piece("0 1 1 1 1 0 2 1")).getSkirt()));
